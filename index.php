...
$router->get('/reservation', 'App\Controller\User#booking');
$router->post('/reservation', 'App\Controller\Auth#postBooking');

$router->get('/reserver', 'App\Controller\User#book');
$router->post('/reserver', 'App\Controller\Booking#postBook');
